...
// Flying Boat                                                                                                                                                                                      
        public class FlyingBoat extends Vehicle implements Floatable, Flyable{
            ...
            public FlyingBoat(String name, String manufacturer, int yearOfManufacture, int maxPassengers, int topSpeed,int numberOfEngines, int maxAltitude, int maxRange, String shippingLineOwner, int tonnage){
