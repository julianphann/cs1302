...
public class Main {
  public static void main(String[] args) {
	  ...
	  //commands 2-6 use instanceof compare object types to display the type of Vehicle of each object.
	  //for- each and for loops go through the Vehicle subclass objects
